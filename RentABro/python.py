...
###Pages###
#Index page, this page is the home page and will have minimal functionality so does not require any python code.
@route('/')
@view('index')
def index():
    return dict(bro = True) #Return True so that the page does not throw an error

#Product page, this page should dsiplay all of the bros so the python will need to pass an array of all of the bros so that the page can display them in a grid.
@route('/products.html')
@view('products.html')
def products():
    try:
...
#Purchase page. This page needs to identify the bro that has been purchased and pass/save required imformation for the next page.
...
#Purchase_success page, this page will need to grab the form inputs from 'Purchase' page and using the inputs calculate total cost and change the booked variables of the bro. It should then return a statement displaying purchase info.
...
#return_product page, this page does not need any python proccessing.
@route('/return_product.html')
@view('return_product.html')
def return_product():
    return dict(bro = True) #Return True so that the page does not throw an error

#return_success page, Grab form inputs form previous pages forms and user them to find the purchase and change the booked variables appropriatly.
...
#Application page, No python required on this page.
